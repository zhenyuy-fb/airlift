...
public class KerberosUtil
{
            ...
            public GSSContext run()
            {
                ...
                try {
                    ...
                    if (initiator) {
                        ...
                        GSSName gssServiceName = gssManager.createName(servicePrincipal, GSSName.NT_HOSTBASED_SERVICE);
            ...
            extends Configuration
    {
        ...
        public KerberosConfiguration(String subjectName, String krb5Config, Boolean client)
                throws UnknownHostException
        {
            if (client) {
        ...
        public AppConfigurationEntry[] getAppConfigurationEntry(String name)
        {
            ...
            switch (name) {
                ...
                case GSS_CLIENT:
                    ...
                    break;
                default:
                    log.error("Invalid krb5LoginModule configuration name %s", name);
                    break;
            }
